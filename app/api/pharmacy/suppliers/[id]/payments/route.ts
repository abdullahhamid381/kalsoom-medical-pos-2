...
export async function POST(req: NextRequest, { params }: {
    ...
    try {
        ...
        const result = await db.prepare(`INSERT INTO supplier_payments (supplier_id, amount, payment_method, reference_no, notes, paid_by_user_id)
       VALUES (?, ?, ?, ?, ?, ?)`).run(id, amount, b.payment_method || 'cash', b.reference_no || null, b.notes || null, session.id);
